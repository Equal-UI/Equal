import{_ as C}from"./Box.vue.20a663c4.js";import{_ as y}from"./PropsTable.20a3c0c8.js";import{i as u,I as $,a as c,b as m,h as o,w as i,e as l,r as g,o as v,z as _,A as T,f as a,t as r}from"./entry.e6c866a5.js";import"./Prism.e5831eb8.js";const E=u({components:{ItBadge:$},props:{}}),w={class:"flex flex-row items-center justify-center space-x-3"},N=l("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",class:"h-5"},[l("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"})],-1),Y=l("p",null,"You have a new message",-1);function B(t,e,d,b,k,h){const n=g("it-badge");return v(),m("div",w,[o(n,{variant:"danger",round:"",point:""},{default:i(()=>[N]),_:1}),Y])}const f=c(E,[["render",B]]);const S=u({setup(){const t=_();function e(d="top"){t({duration:3e3,placement:d},T(f))}return{notification:t,notificationExample:e}},data:()=>({NotificationExample:f,typesTemplate:`<it-button @click="notificationExample()">
