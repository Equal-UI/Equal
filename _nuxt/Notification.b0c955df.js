...
<it-button @click="notificationExample('bottom-right')">
  Bottom-right
</it-button>`,dataSheet:[{property:"progress",type:["Boolean"],default:"false",values:[],description:"Duration line"},{property:"title",type:["String"],default:"-",values:[],description:"Title of the notification"},{property:"text",type:["String"],default:"-",values:[],description:"Content of the notification"},{property:"placement",type:["String"],default:"top-right",values:["top-right","top","top-left","bottom-right","bottom","bottom-left"],description:"Position of the notification"},{property:"duration",type:["Number"],default:"5000",values:[],description:"Duration of the notification"},{property:"on-close",type:["Function"],default:"() => void",values:[],description:"Callback triggers when notification hides"}]})}),D=l("h1",{class:"mb-4 text-2xl font-bold"},"Notification",-1),j={class:"flex flex-col gap-4"},V={class:"flex flex-row justify-center gap-3"},W={class:"flex flex-row justify-center gap-3"},M={class:"flex flex-col gap-4"},I={class:"flex flex-row justify-center gap-3"},q={class:"flex flex-col gap-4"},A={class:"flex flex-row justify-center gap-3"},F={class:"flex flex-col gap-4"},J={class:"flex flex-row justify-center gap-3"};function L(t,e,d,v,b,k){const n=c("it-button"),p=C,h=x;return m(),g("div",null,[D,o(p,{template:t.typesTemplate,code:t.typesCode,title:"Default example"},{default:i(()=>[o(n,{type:"primary",onClick:e[0]||(e[0]=s=>t.notificationExample())},{default:i(()=>[a(" Notification example ")]),_:1})]),_:1},8,["template","code"]),o(p,{template:t.placementCode,code:t.typesCode,title:"Notification position"},{default:i(()=>[l("div",j,[l("div",V,[o(n,{onClick:e[1]||(e[1]=s=>t.notificationExample("top-left"))},{default:i(()=>[a(r(t.$t("sides.top-left")),1)]),_:1}),o(n,{onClick:e[2]||(e[2]=s=>t.notificationExample("top"))},{default:i(()=>[a(r(t.$t("sides.top")),1)]),_:1}),o(n,{onClick:e[3]||(e[3]=s=>t.notificationExample("top-right"))},{default:i(()=>[a(r(t.$t("sides.top-right")),1)]),_:1})]),l("div",W,[o(n,{onClick:e[4]||(e[4]=s=>t.notificationExample("bottom-left"))},{default:i(()=>[a(r(t.$t("sides.bottom-left")),1)]),_:1}),o(n,{onClick:e[5]||(e[5]=s=>t.notificationExample("bottom"))},{default:i(()=>[a(r(t.$t("sides.bottom")),1)]),_:1}),o(n,{onClick:e[6]||(e[6]=s=>t.notificationExample("bottom-right"))},{default:i(()=>[a(r(t.$t("sides.bottom-right")),1)]),_:1})])])]),_:1},8,["template","code"]),o(p,{template:t.variantsCode,code:t.durationCode,title:"Variants"},{default:i(()=>[l("div",M,[l("div",I,[o(n,{onClick:e[7]||(e[7]=s=>t.notification({title:"Task is done",text:"Congratulations! Your task is finished, have a rest",variant:"success",placement:"bottom-right"}))},{default:i(()=>[a(" Success ")]),_:1}),o(n,{onClick:e[8]||(e[8]=s=>t.notification({title:"Task is not available",text:"This task is not available for your type of user",variant:"warning",placement:"bottom-right"}))},{default:i(()=>[a(" Warning ")]),_:1}),o(n,{onClick:e[9]||(e[9]=s=>t.notification({title:"Task is deleted",text:"Your task has been deleted",variant:"danger",placement:"bottom-right"}))},{default:i(()=>[a(" Danger ")]),_:1})])])]),_:1},8,["template","code"]),o(p,{template:t.durationTemplate,code:t.durationCode,title:"Duration line"},{default:i(()=>[l("div",q,[l("div",A,[o(n,{onClick:e[10]||(e[10]=s=>t.notification({title:"Task is done",text:"Congratulations! Your task is finished, have a rest",variant:"success",placement:"bottom-right",progress:!0}))},{default:i(()=>[a(" Success ")]),_:1}),o(n,{onClick:e[11]||(e[11]=s=>t.notification({title:"Task is not available",text:"This task is not available for your type of user",variant:"warning",placement:"bottom-right",progress:!0}))},{default:i(()=>[a(" Warning ")]),_:1}),o(n,{onClick:e[12]||(e[12]=s=>t.notification({title:"Task is deleted",text:"Your task has been deleted",variant:"danger",placement:"bottom-right",progress:!0}))},{default:i(()=>[a(" Danger ")]),_:1})])])]),_:1},8,["template","code"]),o(p,{template:t.variantCode,code:t.durationCode,title:"Custom variant"},{default:i(()=>[l("div",F,[l("div",J,[o(n,{onClick:e[13]||(e[13]=s=>t.notification({title:"Task is done",text:"Congratulations! Your task is finished, have a rest",variants:{sky:{root:"!border-indigo-500/80",title:"!text-indigo-500"}},variant:"sky"}))},{default:i(()=>[a(" Magic ")]),_:1})])])]),_:1},8,["template","code"]),o(h,{"data-sheet":t.dataSheet},null,8,["data-sheet"])])}const K=u(S,[["render",L]]);export{K as default};
