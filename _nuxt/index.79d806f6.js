...
export default {
  data: () => ({
    ...
    `})}),O={class:"mt-2"},S={class:"mt-2"},g={class:"mt-2"},$={class:"mt-2"},N={class:"mt-2"};function v(e,a,w,E,U,A){const t=i("it-select"),s=i("it-divider"),k=d;return b(),T(k,{template:e.codeSectionExamples,title:"Examples"},{default:B(()=>[o(t,{"label-top":"List of string",modelValue:e.exampleStringValue,"onUpdate:modelValue":a[0]||(a[0]=l=>e.exampleStringValue=l),options:e.exampleStringOptions},null,8,["modelValue","options"]),p("pre",O,m(e.exampleStringValue),1),o(s),o(t,{"label-top":"List of number",modelValue:e.exampleNumberValue,"onUpdate:modelValue":a[1]||(a[1]=l=>e.exampleNumberValue=l),options:e.exampleNumberOptions},null,8,["modelValue","options"]),p("pre",S,m(e.exampleNumberValue),1),o(s),o(t,{"label-top":"Track by 'value'(default)",modelValue:e.exampleTrackByValue1,"onUpdate:modelValue":a[2]||(a[2]=l=>e.exampleTrackByValue1=l),options:e.exampleTrackByOptions1},null,8,["modelValue","options"]),p("pre",g,m(e.exampleTrackByValue1),1),o(s),o(t,{"label-top":"Track by 'some'",modelValue:e.exampleTrackByValue2,"onUpdate:modelValue":a[3]||(a[3]=l=>e.exampleTrackByValue2=l),"track-by":"some",options:e.exampleTrackByOptions2},null,8,["modelValue","options"]),p("pre",$,m(e.exampleTrackByValue2),1),o(s),o(t,{"label-top":"Track by 'key'",modelValue:e.exampleTrackByValue3,"onUpdate:modelValue":a[4]||(a[4]=l=>e.exampleTrackByValue3=l),"track-by":"key",options:e.exampleTrackByOptions3},null,8,["modelValue","options"]),p("pre",N,m(e.exampleTrackByValue3),1)]),_:1},8,["template"])}const _=x(f,[["render",v]]);export{_ as default};
