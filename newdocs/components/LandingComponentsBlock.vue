<template>
  <div class="relative grid grid-flow-row-dense sm:grid-cols-2 lg:grid-cols-3">
    <div class="h-full min-h-[10rem] p-1">
      <div
    ...
    <div class="h-full min-h-[10rem] p-1 sm:row-span-2">
      <div
    ...
    <div class="h-full min-h-[10rem] p-1 sm:row-span-2 lg:row-span-1">
      <div
        class="group flex h-full flex-col rounded-lg border bg-white p-4 transition-all dark:border-zinc-600 dark:bg-zinc-800"
      >
        <h4 class="text-xl font-bold tracking-tight dark:text-neutral-50">
    ...
    <div class="h-full min-h-[10rem] p-1 sm:col-span-2">
      <div
        class="group flex h-full gap-6 rounded-lg border bg-white p-4 transition-all dark:border-zinc-600 dark:bg-zinc-800"
      >
        <div class="flex-1">
          <h4 class="text-xl font-bold tracking-tight dark:text-neutral-50">
            Checkboxes
